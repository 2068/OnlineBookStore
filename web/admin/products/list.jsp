        ...
        <tr>
            <td class="ta_01" align="right">
                <button type="button" id="delete" name="delete" value="&#28155;&#21152;"
                        class="button_delete" onclick="batchDelete()">批量删除
                </button>
                ...
                <table cellspacing="0" cellpadding="1" rules="all"
                    ...
                    <c:forEach items="${pageResult.list}" var="book">
                        <tr onmouseover="this.style.backgroundColor = 'white'"
                            ...
                            <td align="center" width="5%">
                                <input type="checkbox" name="ckBookId" value="${book.id}"></td>
                            ...
                            <td align="center" style="HEIGHT: 22px" width="7%">
                                    <%--                                <a href="${pageContext.request.contextPath}/DeleteBookByIdServlet?id=${book.id}">--%>
                    ...
                    <tr>
                        <td colspan="8" align="right">
                            当前页${pageResult.currentPage}/${pageResult.totalPage}总条数${pageResult.totalCount}</td>
                    </tr>
                    <tr>
